...
public class NotificationServiceImpl implements NotificationService {
     ...
     * {@code appointment-email-template.html} expects
     * ({@code appointment.user.fullName},
    ...
    public static final class AppointmentEmailView {
        ...
        public String getId() {
            return ev.appointmentId() != null ? ev.appointmentId().toString() : "";
        }
        ...
        public com.aimelive.urutibot.appointment.model.Appointment.Status getStatus() {
            return ev.status();
        }

        public String getStatusLower() {
            return ev.status() != null ? ev.status().name().toLowerCase() : "";
        }
