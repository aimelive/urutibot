...
import com.aimelive.urutibot.auth.security.ChatAuthContext.AuthSnapshot;
import com.aimelive.urutibot.auth.security.ChatPrincipalResolver;
...
public class AppointmentServiceTools {
     ...
     */
    private static final DateTimeFormatter DATE_TIME_SPACE_FMT = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm");
    ...
    public Object cancelAppointment(@ToolMemoryId String memoryId, String appointmentId) {
        ...
        Long id = parseId(appointmentId);
        if (id == null)
            return Map.of("error", "Invalid appointment ID");
